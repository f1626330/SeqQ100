...
namespace Sequlite.Image.Processing
{
    ...
    public class ImageChannel : ICloneable
    {
        ...
        public ImageChannel() : this(ImageChannelType.Mix)
        {
        ...
        public ImageChannel(ImageChannel otherImageChannel)
        {
            ...
            this.BitDepth = otherImageChannel.BitDepth;
            this.ROI = otherImageChannel.ROI;
        }
    ...
    public class ImageInfo : ICloneable
    {
        ...
        // channel: G1/R3 or G2/R4
        public string ImagingChannel { get; set; }
        #endregion
