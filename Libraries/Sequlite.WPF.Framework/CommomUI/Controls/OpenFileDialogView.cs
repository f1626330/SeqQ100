...
{
	public class OpenFileDialogView : IDialogBoxView<OpenFileDialogViewModel>
	{
		public void Show(OpenFileDialogViewModel vm, Window owner = null)
		{
			...
			dlg.FilterIndex = vm.FilterIndex;
			dlg.CheckFileExists = vm.CheckFileExists;
